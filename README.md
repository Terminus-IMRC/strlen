...
- [Intel Core i7-7820X](https://ark.intel.com/products/123767) with 4-ch DDR4-2133 (PC4-17000) memory and [glibc 2.29](https://sourceware.org/git/?p=glibc.git;a=blob;f=sysdeps/x86_64/multiarch/strlen-avx2.S;h=3e7f14a84603ad5284c443fb0ae157ac99afb1e4;hb=56c86f5dd516284558e106d04b92875d5b623b7a)
...
- [Intel Core i5-7500](https://ark.intel.com/products/97123) with 2-ch(?) DDR4-2400 (PC4-19200) memory and [Apple Libc 1244.50.9](https://opensource.apple.com/source/Libc/Libc-1244.50.9/x86_64/string/strlen.s.auto.html)
...
- [Intel Core i5-7500](https://ark.intel.com/products/97123) with 2-ch(?) DDR4-2400 (PC4-19200) memory and [glibc 2.27](https://sourceware.org/git/?p=glibc.git;a=blob;f=sysdeps/x86_64/multiarch/strlen-avx2.S;h=85d7259746b993bdccb4d0437590494fad045b09;hb=23158b08a0908f381459f273a984c6fd328363cb)
...
- [Intel Core m3-7Y32](https://ark.intel.com/products/97538) with 2-ch(?) LPDDR3-1866 (PC3-14900) memory and [Apple Libc 1244.50.9](https://opensource.apple.com/source/Libc/Libc-1244.50.9/x86_64/string/strlen.s.auto.html)
